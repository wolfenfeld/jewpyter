...
$$\bar{v} = \frac{n}{\displaystyle\sum_i \frac{1}{v_i}}$$
...
$$P_t = P_0 \cdot \prod_{i=1}^{t} \alpha_i$$
...
$$P_0 \cdot \bar{\alpha}^t = P_0 \cdot \prod_i \alpha_i$$

$$\bar{\alpha}^t = \prod_i \alpha_i$$

$$\bar{\alpha} = \left(\prod_i \alpha_i\right)^{1/t}$$
