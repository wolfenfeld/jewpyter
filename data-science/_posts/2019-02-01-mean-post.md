...
$$
\begin{aligned}
  \sum_i \bar{v} \cdot t &= \sum_i x_i \\[1em]
  n \cdot t \cdot \bar{v} &= t \sum_i v_i \\[1em]
...
$$
\begin{aligned}
  P_0 \cdot \bar{\alpha}^t &= P_0 \cdot \prod_i \alpha_i \\[1em]
  \bar{\alpha}^t &= \prod_i \alpha_i \\[1em]
  \bar{\alpha} &= \sqrt[t]{\prod_i \alpha_i}
\end{aligned}
$$
